...
RVI = """
#########################################################################                                  
:FileType          rvi ASCII Raven rev223 (v2.9)                                                                             
:WrittenBy         James Craig & Juliane Mai                                                                       
:CreationDate      November 2019
#
...
:RainSnowFraction        RAINSNOW_DINGMAN    # RAINSNOW_DATA
...
RVP = """
#########################################################################                                  
:FileType          rvp ASCII Raven rev223 (v2.9)                                                                             
:WrittenBy         James Craig & Juliane Mai                                                                       
:CreationDate      November 2019
#
# RAVEN run of WSC/USGS {props[id]} ({props[name]}) using weighted model options                                                                     
...
RVC = """
#########################################################################                                  
:FileType          rvc ASCII Raven rev223 (v2.9)                                                                             
:WrittenBy         James Craig & Juliane Mai                                                                       
:CreationDate      November 2019
#
# RAVEN run of WSC/USGS {props[id]} ({props[name]}) using weighted model options                                                                    
...
RVT = """
#########################################################################                                  
:FileType          rvt ASCII Raven rev223 (v2.9)                                                                             
:WrittenBy         James Craig & Juliane Mai                                                                       
:CreationDate      November 2019
#
# RAVEN run of WSC/USGS {props[id]} ({props[name]}) using weighted model options                                                                    
...
RVH = """
#########################################################################                                  
:FileType          rvh ASCII Raven rev223 (v2.9)                                                                             
:WrittenBy         James Craig & Juliane Mai                                                                       
:CreationDate      November 2019
#
# RAVEN run of WSC/USGS {props[id]} ({props[name]}) using weighted model options                                                            
